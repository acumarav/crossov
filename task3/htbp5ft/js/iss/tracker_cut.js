...
function tleError() {
    var _0xbf08x99 = document.getElementById("errmsg");
    _0xbf08x99["innerHTML"] = "ERROR: Cannot load TLE vector.";
    _0xbf08x99["style"]["display"] = "block";
}
...
function issTrackerResize() {
    ...
    waitmsg["style"]["width"] = (2 * _0xbf08xab) + "px";
    waitmsg["style"]["height"] = (_0xbf08xab) + "px";
    waitmsg = document.getElementById("btn_metric2");
    waitmsg["style"]["width"] = (_0xbf08xab) + "px";
    waitmsg["style"]["height"] = (_0xbf08xab) + "px";
...
function issTracker_init() {
    ...
    if (!!document["createElement"]("canvas")["getContext"]) {
        var _0xbf08x99 = document.getElementById("cover");
        _0xbf08x99["style"]["height"] = (_0xbf08x99["offsetWidth"] * 9.0 / 16.0) + "px";
        canDraw = true;
        isst_ready = false;
        ...
        var _0xbf08x99 = document.getElementById("errmsg");
        _0xbf08x99["innerHTML"] = "Your browser does not support HTML5";
        _0xbf08x99["style"]["display"] = "block";
    };
}