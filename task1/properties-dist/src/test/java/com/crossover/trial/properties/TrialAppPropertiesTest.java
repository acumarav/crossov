...
public class TrialAppPropertiesTest {
    ...
    public void setUp() throws Exception {
        ...
        data = new HashMap<>();
        data.put(jpa_showsql_prop_name, Arrays.asList("true"));
        data.put("score_factor", Arrays.asList("2.4"));
    ...
    public void testInitializeWithWrongValue(){
        data.put(jpa_showsql_prop_name,Arrays.asList("false","not boolean"));
